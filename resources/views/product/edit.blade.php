        ...
        <div class="max-w w-full bg-white shadow-md rounded-md overflow-hidden border">
            <form action="{{route('product-update', $product)}}" method="POST">
                ...
                <div class="px-5 py-3 text-gray-700 border-b">
                    <h3 class="text-md">Edit Product</h3>
                </div>
                ...
                <div class="px-5 py-6 bg-gray-200 text-gray-700 border-b">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price" value="{{$product->price}}" class="my-2 form-input w-full px-4 py-2 border rounded-md focus:border-indigo-600 @error('price') border-red-500 @enderror">
